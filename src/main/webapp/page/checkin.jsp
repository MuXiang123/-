    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item" pane>
            ...
            <div class="layui-input-block">
                <input id="roomliving" name="roomliving" class="layui-input" type="text" readonly="readonly"
                       placeholder="还未选择房间" autocomplete="off" lay-verify="required">
            </div>
        </div>
        ...
        <div class="layui-form-item" pane>
            ...
            <div class="layui-input-inline">
                <input id="deposit" name="deposit" class="layui-input" type="text" readonly="readonly"
                       placeholder="还未选择房间" autocomplete="off" lay-verify="required">
            </div>
                ...
                <div class="layui-colla-item">
                    ...
                    <div class="layui-colla-content layui-show">
                        <div class="layui-form-item" pane>
                            ...
                            <div class="layui-input-block">
                                <input id="identity" name="identity" class="layui-input" type="text" placeholder="输入身份证"
                        ...
                        <div class="layui-form-item" pane>
                            ...
                            <div class="layui-input-block">
                                <input id="name" name="name" class="layui-input" type="text" placeholder="输入姓名"
                ...
                <div class="layui-colla-item">
                    ...
                    <div class="layui-colla-content">
                        <div class="layui-form-item" pane>
                            <label class="layui-form-label">身份证</label>
                            <div class="layui-input-block">
                                <input id="identity2" name="identity2" class="layui-input" type="text" placeholder="选填"
                                       autocomplete="off" lay-verify="optidentity">
                            </div>
                        </div>
                        <div class="layui-form-item" pane>
                            <label class="layui-form-label">姓名</label>
                            <div class="layui-input-block">
                                <input id="name2" name="name2" class="layui-input" type="text" placeholder="选填"
                                       autocomplete="off">
                            </div>
                        </div>
                    </div>
                ...
                <div class="layui-colla-item">
                    ...
                    <div class="layui-colla-content">
                        <div class="layui-form-item" pane>
                            <label class="layui-form-label">身份证</label>
                            <div class="layui-input-block">
                                <input id="identity3" name="identity3" class="layui-input" type="text" placeholder="选填"
                                       autocomplete="off" lay-verify="optidentity">
                            </div>
                        </div>
                        <div class="layui-form-item" pane>
                            <label class="layui-form-label">姓名</label>
                            <div class="layui-input-block">
                                <input id="name3" name="name3" class="layui-input" type="text" placeholder="选填"
                                       autocomplete="off">
                            </div>
                        </div>
                    </div>
        ...
        <div class="layui-form-item">
            <div class="layui-row layui-col-space10">
                <div class="layui-row">
                    ...
                    <div class="layui-col-md1">
                        <div class="grid-demo">
                            <button id="checkinbtn" class="layui-btn" lay-submit="" type="submit"
                                    lay-filter="checkinbtn">入住
                            </button>
                        </div>
                    </div>
                    <div class="layui-col-md1">
